...
func add(object: Object, signal_name: String = "completed"):
	...
	if object is GDScriptFunctionState:
		object.connect("completed", Callable(self, "_signaled"))
	else:
		object.connect(signal_name, Callable(self, "_signaled"))


func remove(object: Object, signal_name: String = "completed"):
	_wait_all_count += 1
	if object is GDScriptFunctionState:
		object.disconnect("completed", Callable(self, "_signaled"))
	else:
		object.disconnect(signal_name, Callable(self, "_signaled"))
