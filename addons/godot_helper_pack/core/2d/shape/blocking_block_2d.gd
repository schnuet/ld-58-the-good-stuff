...
var use_global_color := true: set = _set_use_global_color
var color: Color = Color(1.0,1.0,1.0,1.0): set = _set_color
var texture: Texture2D: set = _set_texture

# applies to all but rect
var non_rect_texture_offset := Vector2.ZERO: set = _set_non_rect_texture_offset
var non_rect_texture_scale := Vector2.ONE: set = _set_non_rect_texture_scale


# applies to rectangle shape - for nine patch
var nine_patch_draw_center := true: set = _set_draw_center
var nine_patch_region_rect: Rect2: set = _set_region_rect
var nine_patch_patch_left := 0: set = _set_patch_left
var nine_patch_patch_right := 0: set = _set_patch_right
var nine_patch_patch_top := 0: set = _set_patch_top
var nine_patch_patch_bottom := 0: set = _set_patch_bottom
var nine_patch_axis_stretch_horizontal: int: set = _set_axis_stretch_horizontal
var nine_patch_axis_stretch_vertical: int: set = _set_axis_stretch_vertical
...
func _get_property_list():
	...
	props.append(_make_prop("Rectangle Shape3D", TYPE_NIL, PROPERTY_USAGE_GROUP, -1, "nine_patch"))
