...
@export var distribution_radius : float = 128.0 # (float, 1.0, 10000.0)
# The area the objects take up - used for multiple layers to reject overlapping objects
@export var object_radius : float = 64.0 # (float, 1.0, 10000.0)
...
@export var scenes_to_distribute: Array = [] # (Array, PackedScene)
